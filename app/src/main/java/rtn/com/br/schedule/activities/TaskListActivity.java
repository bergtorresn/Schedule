...
public class TaskListActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.menu_tasklist, menu);
        return true;
    }
    ...
    private void alertFilter() {
        ...
        View view = getLayoutInflater().inflate(R.layout.dialog_spinner_layout, null);
        ...
        ArrayAdapter<String> arrayAdapterStatus = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, mArrayStatus);
        ArrayAdapter<String> arrayAdapterPriority = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, mArrayPriority);
    ...
    private void sorteByPriorityAndStatus(Integer priority, Integer status) {
        ArrayList<UserTask> arrayAux = new ArrayList<>();
